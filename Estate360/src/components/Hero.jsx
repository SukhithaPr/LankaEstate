        ...
        <section className="container py-5 px-4">
            <div className="row rounded-3 min-vh-60" style={{ backgroundColor: '#f4f8f9' }}>
                <div className="col-md-6 d-flex flex-column justify-content-center p-5 gap-3">
                    ...
                    <p>
                        Discover exceptional properties tailored to your needs. Whether you're buying or renting, we're here to guide you every step of the way. Start your journey to the perfect home now!                    </p>
                    <a href="/shop" className="btn text-white px-4 py-2" style={{ background: '#1A453C' }}>
                        Shop Now
                    </a>
                </div>
